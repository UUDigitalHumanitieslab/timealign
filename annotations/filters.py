...
class AnnotationFilter(FilterSet):
    ...
    original_tense = ModelChoiceFilter(label='Tense',
    ...
    class Meta:
        model = Annotation
        fields = ['corpus', 'is_no_target', 'is_translation', 'original_tense', 'original_labels',
                  'tense', 'labels', 'word_in_source', 'annotated_by']
    ...
    def __init__(self, l1, l2, *args, **kwargs):
        ...
        self.filters['original_labels'] = MultipleChoiceFilter(label='Labels',
